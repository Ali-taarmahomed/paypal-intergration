...
export const Withdrawal = () => {
    ...
    const [myData, setMyData] = useState<WithdrawalT[]>([])

    useEffect(() => {
        const fn = async () => {
            const data: any = await adminGetWithdrawals({
                    ...
                    for (let item of myData) {
                        const link = jsonToUrl({
                            ...
                            jsonData: {
                                ...
                                amountWithdrawnInUsd: String(
                                    item.amountWithdrawnInUsd
                                ),
                        ...
                        const data = (
                            ...
                            >
                                <div className='space-y-3'>
                                    ...
                                    {/* <p className="text-sm text-gray-600">Transaction Code: {item.transactionCode}</p> */}
                                    {/* <p className="text-sm text-gray-600">Bank Details ID: {item.bankDetailsId}</p> */}
                                    <p className='text-sm text-gray-600'>
                                        Confirmed:
                                        {item.isConfirmedByAdmin ? (
                                    ...
                                    {!isSuccessful && (
                                        <div className='grid w-full grid-cols-2 gap-2 py-4'>
                                            <button
                                                ...
                                                className='rounded-lg bg-red-600 px-4 py-2 text-center text-white hover:bg-red-800'
                                            >
                                                Decline
                                            </button>
                                            ...
                                            <Link
                                                href={link}
                                                className='rounded-lg bg-green-600 px-4 py-2 text-center text-white hover:bg-green-800'
                                            >
                                                Approve
                                            </Link>
                                        </div>
