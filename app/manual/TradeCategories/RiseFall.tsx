'use client'
import { DerivTrade, DurationUnitT, EvenT } from '@/lib/tradeFormats'
...
export const RiseFallTradeButtons = ({
    sendMessage,
}: {
    sendMessage: (message: any) => void
}) => {
    ...
    const { evenOddRiseFall } = DerivTrade
    ...
    const evenOddRiseFallRiseFallHandler = (contract: EvenT) => {
