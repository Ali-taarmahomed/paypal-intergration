...
export const EvenOddTradeButtons = ({
    sendMessage,
}: {
    sendMessage: (message: any) => void
}) => {
    ...
    const EvenOddEvenOddHandler = (contract: EvenT) => {
