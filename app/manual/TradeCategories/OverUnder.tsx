...
export const OverUnderTradeButtons = ({
    sendMessage,
}: {
    sendMessage: (message: any) => void
}) => {
    ...
    const overUnderOverUnderHandler = (contract: OverT) => {
