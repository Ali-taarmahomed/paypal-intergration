    ...
    const bots = [
...

        {
            ...
            func: () => {
                ...
                if (tradeHistory[0].contract_type === 'DIGITUNDER') {
                    return [overUnderMatchDiffersHandler('DIGITOVER', 1, 1)]
                } else if (tradeHistory[0].contract_type === 'DIGITOVER') {
                    return [overUnderMatchDiffersHandler('DIGITUNDER', 8, 1)]
                } else {
                    return [overUnderMatchDiffersHandler('DIGITUNDER', 8, 1)]
                }
