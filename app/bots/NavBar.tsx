            ...
            >
                <div className='mt-32 flex flex-col gap-4 p-6'>
                    ...
                    <Link
                        ...
                        className='flex items-center rounded-lg border-2 border-[#FF9F1C] bg-[#141A26] px-1 py-3 text-white shadow-lg transition-colors duration-300 hover:bg-[#f39c12]'
                    >
                        <Image
                            src='/ManualTradingIcon.svg'
                            alt='Aviator Icon'
                            width={30}
                            height={30}
                            className='mr-3'
